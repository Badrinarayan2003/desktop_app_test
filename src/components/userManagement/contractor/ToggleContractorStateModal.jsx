...
import { toggleContractorState }
    from "../../../services/apis/toggleContractorState";

export default function ToggleContractorStateModal({
    isOpen,
    onClose,
    contractor,
    refetchContractors,
